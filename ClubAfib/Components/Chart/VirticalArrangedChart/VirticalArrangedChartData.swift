//
//  VirticalArrangedChartData.swift
//  ClubAfib
//
...
open class VirticalArrangedChartData: BarLineScatterCandleBubbleChartData
{
    ...
    private var _rangeBarData: RangeBarChartData?
    ...
    @objc open var rangeBarData: RangeBarChartData?
    {
        get
        {
            return _rangeBarData
        }
        set
        {
            _rangeBarData = newValue
            notifyDataChanged()
        }
    }
    ...
    {
        print("removeDataSet(index) not supported for VirticalArrangeddData", terminator: "\n")
        return false
    }
    
    open override func removeEntry(_ entry: ChartDataEntry, dataSetIndex: Int) -> Bool
    {
        print("removeEntry(entry, dataSetIndex) not supported for VirticalArrangeddData", terminator: "\n")
        return false
    }
    
    open override func removeEntry(xValue: Double, dataSetIndex: Int) -> Bool
    {
        print("removeEntry(xValue, dataSetIndex) not supported for VirticalArrangeddData", terminator: "\n")
        return false
    }
    ...
    open override func notifyDataChanged()
    {
        ...
        if _rangeBarData !== nil
        {
            _rangeBarData!.notifyDataChanged()
        }
